;;; iani-dark.el --- A dark theme from (Manoj/Iani)

;; Adapted by Iannis Zannos <zannos@gmail.com>
;; Removed italic fonts for compatibility with unicode. 
...
(custom-theme-set-faces
 ...
 '(font-lock-doc-face           ((t (  :foreground "LightCoral"))))
 ...
 '(gnus-emphasis-underline-bold-italic ((t ( :bold t :underline t :slant italic :weight bold))))
 ...
 '(message-header-newsgroups ((t ( :bold t :foreground "papaya whip" :slant italic :weight bold))))
 '(message-header-newsgroups-face ((t ( :bold t :foreground "papaya whip" :slant italic :weight bold))))
 ...
 '(change-log-acknowledgement-face ((t (  :foreground "AntiqueWhite3"))))
 ...
 '(ibuffer-help-buffer-face  ((t (  :foreground "chocolate1"))))
 ...
 '(info-node ((t ( :bold t :foreground "white" :slant italic :weight bold))))
 ...
 '(vm-highlight-url-face  ((t (:bold t  :slant italic :weight bold))))
...
(setq iani-filename load-file-name)

(when load-file-name
  (add-to-list 'custom-theme-load-path
               (file-name-as-directory (file-name-directory load-file-name))))

(provide-theme 'iani-dark)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; iani-dark.el ends here
